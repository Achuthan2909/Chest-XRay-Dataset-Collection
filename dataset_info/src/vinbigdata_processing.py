...
# Define paths
train_images_path = "/Users/anyhow/projects/data_science/Medical-Report-Generation/remote-dataset/vinbigdata-chest-xray-abnormalities-detection/train"
detailed_class_labels_path = "/Users/anyhow/projects/data_science/Medical-Report-Generation/remote-dataset/vinbigdata-chest-xray-abnormalities-detection/train.csv"  # This should be the file with patientId,class
...
class_mapping = detailed_class_df.set_index('image_id')['class_name'].to_dict()

# Create class folders upfront
unique_classes = detailed_class_df['class_name'].unique()
...
def process_train_image(patient_id):
    try:
        ...
        dicom_path = os.path.join(train_images_path, f"{patient_id}.dicom")
